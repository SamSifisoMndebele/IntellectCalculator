...
import com.avidco.intellectcalculator.utils.BinaryArithmetic.complimentBin
...
object ComplementConvert {
    fun fromDecimal(decimalString: String): Conversion {
        return try {
            ...
            Conversion(decimalString,decimalToComplement1(decimalString),decimalToComplement2(decimalString), null )
        } catch (e: Exception) {
            e.printStackTrace()
