...
import com.avidco.intellectcalculator.databinding.Karnaugh2VariablesBinding
import com.avidco.intellectcalculator.ui.karnaugh.logic.Karnaugh2Variables
import com.avidco.intellectcalculator.utils.BaseConvert
...
class Karnaugh2Fragment : KarnaughFragment() {
    ...
    private fun simplifyExpression( exp : String) {
        ...
        val decimal = try {
            BaseConvert.fromRadix(list.distinct().joinToString(" "), 2).decimal.trim().split(" ")
        } catch (e: Exception) {
            listOf()
        }
